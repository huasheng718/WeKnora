...
watch(() => props.documentId, () => { mutationCoordinator.invalidate(); loadCoordinator.invalidate(); submitting.value = false; reviews.value = []; submitCommand = null; load() }, { immediate: true })
watch(() => props.versionId, () => { mutationCoordinator.invalidate(); submitting.value = false; submitCommand = null })
