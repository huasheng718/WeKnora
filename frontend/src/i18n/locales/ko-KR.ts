export default {
  ...
  production: {
    ...
    documentTypes: {
      ...
      fields: { name: "유형 이름", origin: "출처", code: "유형 code", templateKey: "템플릿 키", schemaVersion: "Schema 버전", status: "상태", actions: "작업", blockSchema: "블록 스키마", sourceRequirements: "소스 요구 사항", skillBindings: "스킬 연결", workflowPlan: "워크플로 계획", qualityRules: "품질 규칙", reviewPolicy: "검토 정책", publicationPolicy: "게시 정책" },
      origin: { builtin: "내장", custom: "사용자 지정" },
      summaries: { sections: "필수 섹션 {count}개: {names}", sources: "최소 증거 {minimum}개; 소스: {kinds}; 증거 섹션: {evidence}", review: "검토 단계: {steps}", publication: "대상: {target}; 승인된 검토: {approval}" },
    ...
    documentWorkbench: {
      ...
      annotationStatus: { open: "열림", resolved: "해결됨", dismissed: "무시됨" },
      runStatus: { queued: "대기 중", running: "실행 중", waiting_approval: "승인 대기", completed: "완료", failed: "실패", cancelled: "취소됨" },
      toolApproval: { not_required: "승인 불필요", pending: "대기", approved: "승인됨", rejected: "거부됨" },
      providerTypes: { skill: "스킬", mcp: "MCP", datasource: "데이터 소스" },
      evidenceTypes: { text: "텍스트", json: "JSON", file: "파일", tool_result: "도구 결과" },
    },
