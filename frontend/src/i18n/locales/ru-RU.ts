export default {
  ...
  production: {
    ...
    documentTypes: {
      ...
      derived: 'Производный черновик создан.', deriveFailed: 'Не удалось создать производный черновик типа документа.', deriveRetryHint: 'Введённые данные сохранены; повтор без изменений использует ту же команду.',
