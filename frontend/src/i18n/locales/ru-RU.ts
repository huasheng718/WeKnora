export default {
  menu: {
    ...
    knowledgeProduction: 'Создание знаний',
    chat: 'Диалог',
  ...
  production: {
    ...
    documentTypes: {
      ...
      viewConfiguration: 'Просмотреть конфигурацию', configurationTitle: 'Конфигурация типа документа', deriveDraft: 'Создать производный черновик', deriveTitle: 'Производный черновик типа документа',
      derived: 'Производный черновик создан.', deriveFailed: 'Не удалось создать производный черновик типа документа.', deriveRetryHint: 'Введённые данные сохранены; повтор без изменений использует ту же команду.', deriveBaseUnavailable: 'Базовый тип документа изменён или недоступен. Введённые данные сохранены для справки; закройте панель и выберите тип из обновлённого списка.',
      generatedVersion: 'Назначается сервером', baseVersion: 'Базовая версия', lineageTitle: 'Происхождение и версия', summaryTitle: 'Сводка управления', rawConfigurationTitle: 'Исходная конфигурация JSON',
      notConfigured: 'Не настроено', requiredValue: 'Обязательно', notRequiredValue: 'Необязательно',
      ...
      fields: { name: 'Название типа', origin: 'Источник', code: 'Code типа', templateKey: 'Ключ шаблона', schemaVersion: 'Версия Schema', status: 'Статус', actions: 'Действия', blockSchema: 'Схема блоков', sourceRequirements: 'Требования к источникам', skillBindings: 'Привязки навыков', workflowPlan: 'План процесса', qualityRules: 'Правила качества', reviewPolicy: 'Политика проверки', publicationPolicy: 'Политика публикации' },
      origin: { builtin: 'Встроенный', custom: 'Пользовательский' },
      summaries: { sections: 'Обязательных разделов: {count}. {names}', sources: 'Минимум источников доказательств: {minimum}; типы: {kinds}; раздел доказательств: {evidence}', review: 'Этапы проверки: {steps}', publication: 'Цель: {target}; одобренная проверка: {approval}' },
    ...
    documentWorkbench: {
      ...
      annotationStatus: { open: 'Открыта', resolved: 'Решена', dismissed: 'Отклонена' },
      runStatus: { queued: 'В очереди', running: 'Выполняется', waiting_approval: 'Ожидает одобрения', completed: 'Завершён', failed: 'Ошибка', cancelled: 'Отменён' },
      toolApproval: { not_required: 'Не требуется', pending: 'Ожидает', approved: 'Одобрено', rejected: 'Отклонено' },
      providerTypes: { skill: 'Навык', mcp: 'MCP', datasource: 'Источник данных' },
      evidenceTypes: { text: 'Текст', json: 'JSON', file: 'Файл', tool_result: 'Результат инструмента' },
    },
