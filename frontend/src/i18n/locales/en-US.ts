export default {
  ...
  production: {
    ...
    documentTypes: {
      ...
      viewConfiguration: 'View configuration', configurationTitle: 'Document type configuration', deriveDraft: 'Derive draft', deriveTitle: 'Derive document type draft',
      derived: 'Derived draft created.', deriveFailed: 'Failed to derive the document type draft.', deriveRetryHint: 'Your input is preserved; retrying unchanged input reuses the same command.', deriveBaseUnavailable: 'The base document type changed or is unavailable. Your input is preserved for reference; close this drawer and choose again from the refreshed list.',
      generatedVersion: 'Generated by the server', baseVersion: 'Base version', lineageTitle: 'Lineage and version', summaryTitle: 'Governance summary', rawConfigurationTitle: 'Raw JSON configuration',
      notConfigured: 'Not configured', requiredValue: 'Required', notRequiredValue: 'Not required',
      ...
      fields: { name: 'Type name', origin: 'Source', code: 'Type code', templateKey: 'Template key', schemaVersion: 'Schema version', status: 'Status', actions: 'Actions', blockSchema: 'Block schema', sourceRequirements: 'Source requirements', skillBindings: 'Skill bindings', workflowPlan: 'Workflow plan', qualityRules: 'Quality rules', reviewPolicy: 'Review policy', publicationPolicy: 'Publication policy' },
      origin: { builtin: 'Built-in', custom: 'Custom' },
      summaries: { sections: '{count} required sections: {names}', sources: 'At least {minimum} evidence items; sources: {kinds}; evidence section: {evidence}', review: 'Review steps: {steps}', publication: 'Target: {target}; approved review: {approval}' },
    ...
    documentWorkbench: {
      ...
      annotationStatus: { open: 'Open', resolved: 'Resolved', dismissed: 'Dismissed' },
      runStatus: { queued: 'Queued', running: 'Running', waiting_approval: 'Waiting approval', completed: 'Completed', failed: 'Failed', cancelled: 'Cancelled' },
      toolApproval: { not_required: 'Not required', pending: 'Pending', approved: 'Approved', rejected: 'Rejected' },
      providerTypes: { skill: 'Skill', mcp: 'MCP', datasource: 'Data source' },
      evidenceTypes: { text: 'Text', json: 'JSON', file: 'File', tool_result: 'Tool result' },
    },
