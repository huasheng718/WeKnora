export default {
  ...
  production: {
    ...
    documentTypes: {
      ...
      derived: 'Derived draft created.', deriveFailed: 'Failed to derive the document type draft.', deriveRetryHint: 'Your input is preserved; retrying unchanged input reuses the same command.',
