...
ALTER TABLE production_documents
    ...
    FOREIGN KEY (current_version_id) REFERENCES production_document_versions(id) ON DELETE RESTRICT;
ALTER TABLE production_documents
    ADD CONSTRAINT fk_production_documents_latest_approved_version
    FOREIGN KEY (latest_approved_version_id) REFERENCES production_document_versions(id) ON DELETE RESTRICT;
