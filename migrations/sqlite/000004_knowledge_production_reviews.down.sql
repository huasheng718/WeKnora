...
DROP TRIGGER IF EXISTS trg_production_review_steps_validate_initial_state;
DROP TRIGGER IF EXISTS trg_production_review_steps_fence_parent_insert;
DROP TRIGGER IF EXISTS trg_production_review_requests_terminalize_children;
...
DROP TRIGGER IF EXISTS trg_production_review_requests_validate_initial_state;
