...
func RegisterProductionRoutes(
	...
	production.GET("/source-sets/:id/evidence", g.Viewer(), sourceHandler.ListEvidence)
	production.GET("/projects/:id/documents", g.Viewer(), documentHandler.List)
	production.POST("/projects/:id/documents", g.Contributor(), idempotency.Require(), documentHandler.Create)
	production.GET("/documents/:id", g.Viewer(), documentHandler.Get)
	production.GET("/documents/:id/versions", g.Viewer(), documentHandler.ListVersions)
	production.GET("/documents/:id/versions/:version_id", g.Viewer(), documentHandler.GetVersion)
	...
	production.GET("/documents/:id/runs", g.Viewer(), runHandler.ListDocumentRuns)
	...
	production.GET("/runs/:id/tool-calls", g.Viewer(), runHandler.ListToolCalls)
	...
	production.GET("/documents/:id/reviews", g.Viewer(), reviewHandler.List)
	...
	production.GET("/documents/:id/releases", g.Viewer(), releaseHandler.List)
	production.GET("/documents/:id/release-preflight", g.Contributor(), releaseHandler.Preflight)
